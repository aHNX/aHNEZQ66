self.addEventListener('message', function(e) {
  ...
  if (packer === 'evalencode') {
    ...
    try {
      self.importScripts('https://cdn.jsdelivr.net/gh/aHNX/aHNEZQ66/AAdecode.js');
    ...
    try {
      self.importScripts('https://cdn.jsdelivr.net/gh/aHNX/aHNEZQ66/JJdecode.js');
    ...
    try {
      self.importScripts('https://cdn.jsdelivr.net/gh/aHNX/aHNEZQ66/URLencode.js');
    ...
    try {
      self.importScripts('https://cdn.jsdelivr.net/gh/aHNX/aHNEZQ66/P_a_c_k_e_r.js');
    ...
    try {
      self.importScripts('https://cdn.jsdelivr.net/gh/aHNX/aHNEZQ66/Js_Obfuscator.js');
    ...
    try {
      self.importScripts('https://cdn.jsdelivr.net/gh/aHNX/aHNEZQ66/My_Obfuscate.js');
